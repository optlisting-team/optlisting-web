      ...
      <div className="relative bg-zinc-900 border border-zinc-700 rounded-2xl shadow-2xl max-w-md w-full mx-4 p-6">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Analyzing Listings</h2>
              <p className="text-sm text-zinc-400">Credit consumption required</p>
            </div>
          </div>
        </div>
          ...
          {listingCount > 0 && (
            <div className="mt-2 pt-2 border-t border-zinc-700/50">
              <span className="text-xs text-zinc-500">
                Analyzing {listingCount.toLocaleString()} listings
              </span>
            </div>
          )}
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="mt-2 text-sm text-zinc-400 ml-8">
